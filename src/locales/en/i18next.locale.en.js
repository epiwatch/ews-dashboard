export const i18next_en = {
  ...
  home: {
    heading: "Prevent the Next Pandemic with Epidemic Intelligence",
    subtitle: "Harness the power of AI and open-source data to capture early epidemic signals globally and rapid epidemic detection, leading to the prevention of global spread."
  },
  map: {
    ...
    no_filter_tag: "No diseases/syndromes were selected."
  },
  stats: {
    country_tag: "Country",
    start_date_tag: "Start Date",
