export const i18next_hi = {
  ...
  home: {
    heading: "महामारी संबंधी बुद्धिमत्ता से अगली महामारी को रोकें",
    subtitle: "वैश्विक स्तर पर शुरुआती महामारी संकेतों को पकड़ने और तेजी से महामारी का पता लगाने के लिए एआई और ओपन-सोर्स डेटा की शक्ति का उपयोग करें, जिससे वैश्विक प्रसार को रोका जा सके।"
  },
  map: {
    ...
    syndromes_selected: "चयनित {{val, number}} सिंड्रोम",
    all_diseases: "सभी रोग",
    all_diseases_upper: "सभी रोग",
    clear: "साफ़",
    loading: "यह लोड हो रहा है...",
    no_filter_tag: "कोई रोग/सिंड्रोम नहीं चुना गया."
  },
  stats: {
    country_tag: "देश",
    start_date_tag: "आरंभ तिथि",
